...
class ObjectDetection():
    ...
    def __init__(self, conf_thresh=0.8, nms_thresh=0.4, weights_path='./object_detection/yolov3_pytorch/weights/yolov3_original.pth'):
        self.conf_thresh = conf_thresh
        self.nms_thres = nms_thresh
        self.net = YoloNetV3()
        self.net.load_state_dict(torch.load(weights_path))
        self.net.eval()
        self.classes = self.load_classes('./object_detection/yolov3_pytorch/classes.txt')
    ...
    def draw_result(self, img, boxes, show=False):
        ...
        for box in boxes:
            ...
            font_size = 20
            class_font = ImageFont.truetype("./object_detection/yolov3_pytorch/fonts/Roboto-Regular.ttf", font_size)
...
#     image_dataset = ImageFolder('/Users/sgarlanka/Personal/AutoBot/server/object_detection/yolov3/images')
...
#         print(images.shape)
#         if image_to_show in file_names[0]:
